...
static void adc_interrupt_callback(asdk_adc_callback_t params);
...
int main()
{
    ...
    asdk_adc_install_callback(adc_interrupt_callback);
...
void adc_interrupt_callback(asdk_adc_callback_t params)
{
    if(params.adc_pin == MCU_PIN_45 && 
        params.callback_reason == ASDK_ADC_CALLBACK_REASON_CONVERSION_COMPLETE)
    {
